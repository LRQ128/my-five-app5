Build failed at Tue Jul 28 04:51:19 UTC 2026

## Run #24
Commit: 38e81cc6111482918185a81ffa3054173a172587
...
lib/services/agent_engine.dart:112:3: Context: Found this candidate, but the arguments don't match.
  AgentEngine({
  ^^^^^^^^^^^
lib/services/agent_engine.dart:509:26: Error: 'await' can only be used in 'async' or 'async*' methods.
          final result = await _executeToolSync(tool, toolCallInfo.arguments);
                         ^^^^^
lib/services/agent_engine.dart:514:24: Error: The getter 'funcArgs' isn't defined for the class 'AgentEngine'.
 - 'AgentEngine' is from 'package:local_ai_assistant/services/agent_engine.dart' ('lib/services/agent_engine.dart').
Try correcting the name to the name of an existing getter, or defining a getter or field named 'funcArgs'.
            arguments: funcArgs,
                       ^^^^^^^^
lib/services/agent_engine.dart:542:12: Error: A value of type 'List<Message>' can't be returned from a function with return type 'Future<List<Message>>'.
...
Running Gradle task 'assembleRelease'...                          149.5s
