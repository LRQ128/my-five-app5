...
class ModelConfig {
  ...
  static const List<ModelConfig> recommendedModels = [
    ModelConfig(
      ...
      filePath: 'hf://Qwen/Qwen2.5-1.5B-Instruct-GGUF/qwen2.5-1.5b-instruct-q4_k_m.gguf',
      description: 'Qwen2.5 1.5B，约1GB，手机首选',
      modelSize: 1500000000,
      quantization: 'Q4_K_M',
      isDefault: true,
    ),
    ModelConfig(
      id: 'qwen2.5-7b',
      name: 'Qwen2.5 7B',
      filePath: 'hf://Qwen/Qwen2.5-7B-Instruct-GGUF/qwen2.5-7b-instruct-q4_k_m.gguf',
    ...
    ModelConfig(
      id: 'llama3.2-3b',
      name: 'Llama 3.2 3B',
      filePath: 'hf://bartowski/Llama-3.2-3B-Instruct-GGUF/Llama-3.2-3B-Instruct-Q4_K_M.gguf',
      description: 'Meta Llama 3.2 3B版，约2GB',
    ...
    ModelConfig(
      ...
      filePath: 'hf://microsoft/Phi-3-mini-4k-instruct-gguf/Phi-3-mini-4k-instruct-q4.gguf',
      description: 'Microsoft Phi-3 Mini 3.8B，约2.5GB',
      modelSize: 3800000000,
      quantization: 'Q4_K_M',
    ),
  ];
}
